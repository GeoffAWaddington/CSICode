...
public:
    ...
    virtual void RequestUpdate(ActionContext *context, int paramNum) override
    {
        ...
        if (GetLastTouchedFX(&trackNum, &fxSlotNum, &fxParamNum))
        {
            ...
            {
                char tmp[BUFSZ];
                TrackFX_GetParamName(DAW::GetTrack(trackNum), fxSlotNum, paramNum, tmp, sizeof(tmp));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class SaveTemplatedFXParams : public Action
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    ...
    void Do(ActionContext *context, double value) override
    {
        ...
        context->GetSurface()->GetZoneManager()->SaveTemplatedFXParams();
    }
};
