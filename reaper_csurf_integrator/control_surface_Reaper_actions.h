...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class ShuttleLeft : public Action
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    virtual string GetName() override { return "ShuttleLeft"; }

    virtual void Do(ActionContext* context, double value) override
    {
        if(value == 0.0)
            context->GetSurface()->StopShuttlingLeft();
        else
            context->GetSurface()->StartShuttlingLeft();
    }
};

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class ShuttleRight : public Action
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    virtual string GetName() override { return "ShuttleRight"; }

    virtual void Do(ActionContext* context, double value) override
    {
        if(value == 0.0)
            context->GetSurface()->StopShuttlingRight();
        else
            context->GetSurface()->StartShuttlingRight ();
    }
};
