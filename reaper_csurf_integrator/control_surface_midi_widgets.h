...
public:
    ...
    PressRelease_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> press) : Midi_CSIMessageGenerator(widget), press_(press)
    {
        lastReceived = 0;
    }
    
    PressRelease_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> press, shared_ptr<MIDI_event_ex_t> release) : Midi_CSIMessageGenerator(widget), press_(press), release_(release)
    {
        lastReceived = 0;
    }
...
public:
    ...
    Touch_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> press, shared_ptr<MIDI_event_ex_t> release) : Midi_CSIMessageGenerator(widget), press_(press), release_(release) {}
...
public:
    ...
    AnyPress_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> press) : Midi_CSIMessageGenerator(widget), press_(press) {}
...
public:
    ...
    Fader14Bit_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message) : Midi_CSIMessageGenerator(widget) {}
...
public:
    ...
    FaderportClassicFader14Bit_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message1, shared_ptr<MIDI_event_ex_t> message2) : Midi_CSIMessageGenerator(widget)
    {
        message1_ = message1;
        message2_ = message2;
    }
...
public:
    ...
    Fader7Bit_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message) : Midi_CSIMessageGenerator(widget) {}
...
public:
    ...
    AcceleratedPreconfiguredEncoder_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message, double stepSize, map<int, int> accelerationValuesForDecrement, map<int, int> accelerationValuesForIncrement, vector<double> accelerationValues) :  Midi_CSIMessageGenerator(widget)
    {
...
public:
    ...
    AcceleratedEncoder_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message, vector<string> params) : Midi_CSIMessageGenerator(widget)
    {       
...
public:
    ...
    MFT_AcceleratedEncoder_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message, vector<string> params) : Midi_CSIMessageGenerator(widget)
    {
...
public:
    ...
    Encoder_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message) : Midi_CSIMessageGenerator(widget) {}
...
public:
    ...
    EncoderPlain_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message) : Midi_CSIMessageGenerator(widget) {}
...
public:
    ...
    Encoder7Bit_Midi_CSIMessageGenerator(Widget *widget, shared_ptr<MIDI_event_ex_t> message) : Midi_CSIMessageGenerator(widget)
    {
        lastMessage = -1;
    }
...
public:
    ...
    TwoState_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1, shared_ptr<MIDI_event_ex_t> feedback2) : Midi_FeedbackProcessor(surface, widget, feedback1, feedback2) { }
...
public:
    ...
    FPTwoStateRGB_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
        active_ = false;
    }
...
public:
    ...
    SCE24TwoStateLED_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
        lastValue_ = 0.0;
    }
...
public:
    ...
    SCE24OLED_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) :
...
public:
    ...
    SCE24Text_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) :
      Midi_FeedbackProcessor(surface, widget, feedback1),
      rows_(true, RowInfo::dispose)
    {
    }
...
public:
    ...
    SCE24Encoder_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    NovationLaunchpadMiniRGB7Bit_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    FaderportRGB_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    AsparionRGB_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
...
public:
    ...
    Fader14Bit_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
...
public:
    ...
    FaderportClassicFader14Bit_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1, shared_ptr<MIDI_event_ex_t> feedback2) : Midi_FeedbackProcessor(surface, widget, feedback1, feedback2)
    {
        shouldSetToZero_ = false;
        timeZeroValueReceived_ = 0;
    }
...
public:
    ...
    Fader7Bit_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    Encoder_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    AsparionEncoder_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
        displayMode_ = 0;
    }
...
public:
    ...
    ConsoleOneVUMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
...
public:
    ...
    ConsoleOneGainReductionMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1)
    {
        minDB_ = 0.0;
        maxDB_ = 24.0;
    }
...
public:
    ...
    QConProXMasterVUMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int param) : Midi_FeedbackProcessor(surface, widget), param_(param)
    {
        minDB_ = 0.0;
        maxDB_ = 24.0;
        param_ = 0;
...
public:
    ...
    MCUVUMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayType, int channelNumber) : Midi_FeedbackProcessor(surface, widget), displayType_(displayType), channelNumber_(channelNumber)
    {
        lastMidiValue_ = 0;
        isClipOn_ = false;
    }
...
public:
    ...
    AsparionVUMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayType, int channelNumber, bool isRight) : Midi_FeedbackProcessor(surface, widget), displayType_(displayType), channelNumber_(channelNumber),  isRight_(isRight)
    {
        lastMidiValue_ = 0;
        isClipOn_ = false;
    }
...
public:
    ...
    FPVUMeter_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int channelNumber) : Midi_FeedbackProcessor(surface, widget), channelNumber_(channelNumber)
    {
        lastMidiValue_ = 0;
        isClipOn_ = false;
    }
...
public:
    ...
    FPValueBar_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int channel) : Midi_FeedbackProcessor(surface, widget), channel_(channel)
    {
        lastValue_ = 0;
    }
...
public:
    ...
    MCUDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayUpperLower, int displayType, int displayRow, int channel) : Midi_FeedbackProcessor(surface, widget), offset_(displayUpperLower * 56), displayType_(displayType), displayRow_(displayRow), channel_(channel)
    {
        lastStringSent_ = "";
    }
...
public:
    ...
    AsparionDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayRow, int displayType, int displayTextType, int channel) : Midi_FeedbackProcessor(surface, widget), displayRow_(displayRow), displayType_(displayType), displayTextType_(displayTextType), channel_(channel)
    {
        lastStringSent_ = "";
    }
...
public:
    ...
    XTouchDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayUpperLower, int displayType, int displayRow, int channel) : Midi_FeedbackProcessor(surface, widget), offset_(displayUpperLower * 56), displayType_(displayType), displayRow_(displayRow), channel_(channel)
    {
        preventUpdateTrackColors_ = false;
        lastStringSent_ = "";
        availableColors =
...
public:
    ...
    FPDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayType, int channel, int displayRow) : Midi_FeedbackProcessor(surface, widget), displayType_(displayType), channel_(channel), displayRow_(displayRow)
    {
        lastStringSent_ = " ";
    }
...
public:
    ...
    FPScribbleStripMode_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayType, int channel) : Midi_FeedbackProcessor(surface, widget), displayType_(displayType), channel_(channel)
    {
        lastMode_ = 0;
    }
...
public:
    ...
    QConLiteDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, int displayUpperLower, int displayType, int displayRow, int channel) : Midi_FeedbackProcessor(surface, widget), offset_(displayUpperLower * 28), displayType_(displayType), displayRow_(displayRow), channel_(channel)
    {
        lastStringSent_ = "";
    }
...
public:
    FB_MCU_AssignmentDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget) : Midi_FeedbackProcessor(surface, widget)
    {
...
public:
    MCU_TimeDisplay_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget) : Midi_FeedbackProcessor(surface, widget) {}
...
public:
    ...
    MFT_RGB_Midi_FeedbackProcessor(shared_ptr<Midi_ControlSurface> surface, Widget *widget, shared_ptr<MIDI_event_ex_t> feedback1) : Midi_FeedbackProcessor(surface, widget, feedback1) { }
